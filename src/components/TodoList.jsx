    ...
    <div className="text-center pt-24">
      <div className="inline-block bg-white border-2 p-6 rounded-lg max-w-full w-full sm:w-auto">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          <button
            className="border-[3px] border-red-800 text-black px-4 py-2 text-center rounded-2xl hover:bg-red-800 hover:text-white transition duration-300"
            onClick={() => setFillter("all")}
          >
            All
          </button>
          <button
            className="border-[3px] border-yellow-500 text-black px-3 py-2 text-center rounded-3xl hover:bg-yellow-500 hover:text-white transition duration-300"
            onClick={() => setFillter("pending")}
          >
            Pending
          </button>
          <button
            className="border-[3px] border-green-600 text-black px-3 py-2 text-center rounded-3xl hover:bg-green-600 hover:text-white transition duration-300"
